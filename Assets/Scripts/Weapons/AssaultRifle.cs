...
public class AssaultRifle : Weapon
{
	...
	public AssaultRifle() : base(WeaponType.AUTOMATIC, ProjectileType.PENETRATING, 10, 90, 20)
	{
		CreateRecoilPattern();
	}
	...
	private void CreateRecoilPattern()
	{
		...
		recoilPattern.Add(new Vector2(3f, 0.7f));
		recoilPattern.Add(new Vector2(3f, 1f));
		recoilPattern.Add(new Vector2(3f, 1f));
		recoilPattern.Add(new Vector2(3f, 1f));
		recoilPattern.Add(new Vector2(3f, 1.2f));
		recoilPattern.Add(new Vector2(3f, 1.3f));
